 ...
 *
 * The legacy `reasoning` column / wire key was dropped when the
 * `displayReasoning` round-trip was removed — reasoning now lives only
 * in `content_blocks[]` of `type === "thinking"`.
 */
